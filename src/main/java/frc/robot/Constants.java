...
public final class Constants {
  public static final class DriveConstants {
    ...
    // SPARK MAX CAN IDs
    public static final int kFrontLeftDrivingCanId = 20; // disable the encoders feedback, may need to add autonomus for that
    ...
    public static final int kRearRightTurningCanId = 25;
  ...
  public static final class ModuleConstants {
    ...
    public static final double kWheelDiameterMeters = Units.inchesToMeters(2.95);
